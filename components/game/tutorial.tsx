...
export const LEARN_STEPS: LearnStep[] = [
  ...
  { id: 'road', target: 'map', icon: ASSETS.misc.spade, title: 'Bend the road',
    body: 'Between waves, click one square of road and an arrow to pull it a tile aside — a longer road is a longer walk under your towers.',
...
export const TLDR: TldrTab[] = [
  { id: 'basics', label: 'Basics', icon: ASSETS.misc.orb_hitpoints, lines: [
    ...
    { icon: ASSETS.misc.spade, text: 'Pay to pull one square of road a tile aside; click its handle to fill it back in.' },
