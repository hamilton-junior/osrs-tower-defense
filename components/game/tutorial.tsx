...
export const LEARN_STEPS: LearnStep[] = [
  ...
  { id: 'uiscale', target: 'uiscale', spotlight: true, uiSizeControl: true, title: 'Set your interface size',
    body: 'These − and + resize the whole interface. Set it now, the game waits.',
  ...
  { id: 'sidebar', target: 'stones', icon: iconUrl('Collection_log'), title: 'The buttons',
    body: 'The buttons on the right open the shops, the log and this guide. Click one again to close it.',
  ...
  { id: 'fishing', target: 'stones', icon: ASSETS.misc.skill_fishing, title: 'Fishing',
    body: 'Click a pool between waves to cast. Eat the fish for lives.',
    when: (ui) => !ui.waveActive && ui.fishingSpots.length > 0 },
  { id: 'traps', target: 'dock', icon: itemIcon('bird_snare'), title: 'Trap the road',
    body: 'The Traps tab lays snares on the road itself. Enemies walk straight over them.',
  ...
  { id: 'affix', icon: ASSETS.misc.defence_icon, title: 'Elite enemies',
    body: 'A glowing enemy breaks one rule, and the aura colour says which. Vary your towers.',
