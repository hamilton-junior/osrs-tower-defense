...
export const DRAFT_POOL: readonly DraftCard[] = [
  ...
  { id: 'strength_potion', name: 'Strength Potion', desc: '+3% damage for melee towers', rarity: 'common', icon: itemIcon('strength_potion'), effect: { kind: 'damage', mult: DMG.common, style: 'melee' } },
  { id: 'super_strength', name: 'Super Strength', desc: '+5% damage for melee towers', rarity: 'uncommon', icon: itemIcon('super_strength'), effect: { kind: 'damage', mult: DMG.uncommon, style: 'melee' } },
  { id: 'super_combat', name: 'Super Combat Potion', desc: '+7.5% damage for melee towers', rarity: 'rare', icon: itemIcon('super_combat_potion'), effect: { kind: 'damage', mult: DMG.rare, style: 'melee' } },
  // ──────────────────────── ranged damage (potions) ───────────────────────
  { id: 'ranging_potion', name: 'Ranging Potion', desc: '+3% damage for ranged towers', rarity: 'common', icon: itemIcon('ranging_potion'), effect: { kind: 'damage', mult: DMG.common, style: 'ranged' } },
  { id: 'super_ranging', name: 'Divine Ranging Potion', desc: '+5% damage for ranged towers', rarity: 'uncommon', icon: itemIcon('divine_ranging_potion'), effect: { kind: 'damage', mult: DMG.uncommon, style: 'ranged' } },
  { id: 'bastion_potion', name: 'Bastion Potion', desc: '+7.5% damage for ranged towers', rarity: 'rare', icon: itemIcon('bastion_potion'), effect: { kind: 'damage', mult: DMG.rare, style: 'ranged' } },
  // ───────────────────────── magic damage (potions) ───────────────────────
  { id: 'magic_potion', name: 'Magic Potion', desc: '+3% damage for magic towers', rarity: 'common', icon: itemIcon('magic_potion'), effect: { kind: 'damage', mult: DMG.common, style: 'magic' } },
  { id: 'battlemage_potion', name: 'Battlemage Potion', desc: '+5% damage for magic towers', rarity: 'uncommon', icon: itemIcon('battlemage_potion'), effect: { kind: 'damage', mult: DMG.uncommon, style: 'magic' } },
  { id: 'imbued_heart', name: 'Imbued Heart', desc: '+7.5% damage for magic towers', rarity: 'rare', icon: itemIcon('imbued_heart'), effect: { kind: 'damage', mult: DMG.rare, style: 'magic' } },
  // ──────────────────────── general damage (Overload) ─────────────────────
  { id: 'overload', name: 'Overload', desc: '+11% damage for ALL towers', rarity: 'ultra', icon: itemIcon('overload_4'), effect: { kind: 'damage', mult: DMG.ultra } },

  // ───────────────────────── melee speed (weapons) ────────────────────────
  { id: 'rune_scimitar', name: 'Rune Scimitar', desc: '+1.5% attack speed for melee towers', rarity: 'common', icon: itemIcon('rune_scimitar'), effect: { kind: 'fireRate', mult: SPD.common, style: 'melee' } },
  { id: 'dragon_scimitar', name: 'Dragon Scimitar', desc: '+2% attack speed for melee towers', rarity: 'uncommon', icon: itemIcon('dragon_scimitar'), effect: { kind: 'fireRate', mult: SPD.uncommon, style: 'melee' } },
  { id: 'abyssal_whip', name: 'Abyssal Whip', desc: '+3% attack speed for melee towers', rarity: 'rare', icon: itemIcon('abyssal_whip'), effect: { kind: 'fireRate', mult: SPD.rare, style: 'melee' } },
  // ──────────────────────── ranged speed (weapons) ────────────────────────
  { id: 'rapid_stance', name: 'Rune Knife', desc: '+1.5% attack speed for ranged towers', rarity: 'common', icon: itemIcon('rune_knife'), effect: { kind: 'fireRate', mult: SPD.common, style: 'ranged' } },
  { id: 'magic_shortbow', name: 'Magic Shortbow', desc: '+2% attack speed for ranged towers', rarity: 'uncommon', icon: itemIcon('magic_shortbow'), effect: { kind: 'fireRate', mult: SPD.uncommon, style: 'ranged' } },
  { id: 'dragon_darts', name: 'Dragon Darts', desc: '+3% attack speed for ranged towers', rarity: 'rare', icon: itemIcon('dragon_dart'), effect: { kind: 'fireRate', mult: SPD.rare, style: 'ranged' } },
  // ───────────────────────── magic speed (weapons) ────────────────────────
  { id: 'swift_glyphs', name: 'Staff of Air', desc: '+1.5% attack speed for magic towers', rarity: 'common', icon: itemIcon('staff_of_air'), effect: { kind: 'fireRate', mult: SPD.common, style: 'magic' } },
  { id: 'trident_seas', name: 'Trident of the Seas', desc: '+2% attack speed for magic towers', rarity: 'uncommon', icon: itemIcon('trident_of_the_seas'), effect: { kind: 'fireRate', mult: SPD.uncommon, style: 'magic' } },
  { id: 'harmonised_staff', name: 'Harmonised Staff', desc: '+3% attack speed for magic towers', rarity: 'rare', icon: itemIcon('harmonised_nightmare_staff'), effect: { kind: 'fireRate', mult: SPD.rare, style: 'magic' } },
  // ──────────────────── general speed (Stamina, top tier) ──────────────────
  { id: 'war_tempo', name: 'Stamina Potion', desc: '+4% attack speed for ALL towers', rarity: 'ultra', icon: itemIcon('stamina_potion'), effect: { kind: 'fireRate', mult: SPD.ultra } },

  // ───────────────────────── melee range (halberds) ───────────────────────
  { id: 'halberd', name: 'Rune Halberd', desc: '+1.5% range for melee towers', rarity: 'common', icon: itemIcon('rune_halberd'), effect: { kind: 'range', mult: RNG.common, style: 'melee' } },
  { id: 'dragon_halberd', name: 'Dragon Halberd', desc: '+2% range for melee towers', rarity: 'uncommon', icon: itemIcon('dragon_halberd'), effect: { kind: 'range', mult: RNG.uncommon, style: 'melee' } },
  { id: 'noxious_halberd', name: 'Noxious Halberd', desc: '+3% range for melee towers', rarity: 'rare', icon: itemIcon('noxious_halberd'), effect: { kind: 'range', mult: RNG.rare, style: 'melee' } },
  // ─────────────────────────── ranged range (bows) ────────────────────────
  { id: 'longrange_stance', name: 'Magic Longbow', desc: '+1.5% range for ranged towers', rarity: 'common', icon: itemIcon('magic_longbow'), effect: { kind: 'range', mult: RNG.common, style: 'ranged' } },
  { id: 'eagle_eye', name: 'Dark Bow', desc: '+2% range for ranged towers', rarity: 'uncommon', icon: itemIcon('dark_bow'), effect: { kind: 'range', mult: RNG.uncommon, style: 'ranged' } },
  { id: 'twisted_bow', name: 'Twisted Bow', desc: '+3% range for ranged towers', rarity: 'rare', icon: itemIcon('twisted_bow'), effect: { kind: 'range', mult: RNG.rare, style: 'ranged' } },
  // ────────────────────────── magic range (staves) ────────────────────────
  { id: 'iban_staff', name: "Iban's Staff", desc: '+1.5% range for magic towers', rarity: 'common', icon: itemIcon('ibans_staff'), effect: { kind: 'range', mult: RNG.common, style: 'magic' } },
  { id: 'ahrims_staff', name: "Ahrim's Staff", desc: '+2% range for magic towers', rarity: 'uncommon', icon: itemIcon('ahrims_staff'), effect: { kind: 'range', mult: RNG.uncommon, style: 'magic' } },
  { id: 'nightmare_staff', name: 'Nightmare Staff', desc: '+3% range for magic towers', rarity: 'rare', icon: itemIcon('nightmare_staff'), effect: { kind: 'range', mult: RNG.rare, style: 'magic' } },
  // ──────────────────── general range (Hunter, top tier) ───────────────────
  { id: 'far_sight', name: 'Hunter Potion', desc: '+4% range for ALL towers', rarity: 'ultra', icon: itemIcon('hunter_potion'), effect: { kind: 'range', mult: RNG.ultra } },
  ...
  // ───────────────────────────── combo cards ──────────────────────────────
  { id: 'berserker_ring', name: 'Berserker Ring', desc: '+3% damage & +1.5% attack speed for melee', rarity: 'uncommon', icon: itemIcon('berserker_ring'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.common, style: 'melee' }, { kind: 'fireRate', mult: SPD.common, style: 'melee' }] } },
  { id: 'pegasian_boots', name: 'Pegasian Boots', desc: '+2% range & +2% attack speed for ranged', rarity: 'rare', icon: itemIcon('pegasian_boots'),
  ...
  { id: 'rangers_kit', name: 'Ranger Boots', desc: '+1.5% range & +1.5% attack speed for ranged', rarity: 'uncommon', icon: itemIcon('ranger_boots'),
    effect: { kind: 'multi', effects: [{ kind: 'range', mult: RNG.common, style: 'ranged' }, { kind: 'fireRate', mult: SPD.common, style: 'ranged' }] } },
  { id: 'occult_necklace', name: 'Occult Necklace', desc: '+5% damage & +2% attack speed for magic', rarity: 'rare', icon: itemIcon('occult_necklace'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.uncommon, style: 'magic' }, { kind: 'fireRate', mult: SPD.uncommon, style: 'magic' }] } },
  { id: 'void_knight', name: 'Void Knight', desc: '+3% damage & +1.5% attack speed for ALL towers', rarity: 'rare', icon: itemIcon('void_knight_top'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.common }, { kind: 'fireRate', mult: SPD.common }] } },
  { id: 'inquisitors_set', name: "Inquisitor's Set", desc: '+7.5% damage, +3% attack speed & +3% range for melee', rarity: 'ultra', icon: itemIcon('inquisitors_great_helm'),
  ...
  { id: 'elite_void', name: 'Elite Void', desc: '+5% damage, +2% range & +2% attack speed for ALL', rarity: 'ultra', icon: itemIcon('elite_void_top'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.uncommon }, { kind: 'range', mult: RNG.uncommon }, { kind: 'fireRate', mult: SPD.uncommon }] } },
  { id: 'dragon_boots', name: 'Dragon Boots', desc: '+3% damage & +1.5% range for melee', rarity: 'uncommon', icon: itemIcon('dragon_boots'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.common, style: 'melee' }, { kind: 'range', mult: RNG.common, style: 'melee' }] } },
  { id: 'archers_ring', name: 'Archers Ring', desc: '+3% damage & +1.5% range for ranged', rarity: 'uncommon', icon: itemIcon('archers_ring'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.common, style: 'ranged' }, { kind: 'range', mult: RNG.common, style: 'ranged' }] } },
  { id: 'seers_ring', name: 'Seers Ring', desc: '+3% damage & +1.5% range for magic', rarity: 'uncommon', icon: itemIcon('seers_ring'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.common, style: 'magic' }, { kind: 'range', mult: RNG.common, style: 'magic' }] } },
  { id: 'fire_cape', name: 'Fire Cape', desc: '+5% damage & +2% range for melee', rarity: 'rare', icon: itemIcon('fire_cape'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.uncommon, style: 'melee' }, { kind: 'range', mult: RNG.uncommon, style: 'melee' }] } },
  { id: 'avas_assembler', name: "Ava's Assembler", desc: '+5% damage & +2% attack speed for ranged', rarity: 'rare', icon: itemIcon('avas_assembler'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.uncommon, style: 'ranged' }, { kind: 'fireRate', mult: SPD.uncommon, style: 'ranged' }] } },
  { id: 'eternal_boots', name: 'Eternal Boots', desc: '+5% damage & +2% range for magic', rarity: 'rare', icon: itemIcon('eternal_boots'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.uncommon, style: 'magic' }, { kind: 'range', mult: RNG.uncommon, style: 'magic' }] } },
  { id: 'amulet_of_fury', name: 'Amulet of Fury', desc: '+5% damage & +2% attack speed for melee', rarity: 'rare', icon: itemIcon('amulet_of_fury'),
    effect: { kind: 'multi', effects: [{ kind: 'damage', mult: DMG.uncommon, style: 'melee' }, { kind: 'fireRate', mult: SPD.uncommon, style: 'melee' }] } },
  { id: 'masori_set', name: 'Masori Armour', desc: '+7.5% damage, +3% range & +3% attack speed for ranged', rarity: 'ultra', icon: itemIcon('masori_body'),
  ...
  { id: 'ancestral_set', name: 'Ancestral Robes', desc: '+7.5% damage, +3% range & +3% attack speed for magic', rarity: 'ultra', icon: itemIcon('ancestral_robe_top'),
  ...
  // ── on-kill chain reactions ──────────────────────────────────────────────
  { id: 'dragon_claws', name: 'Dragon Claws', desc: 'A kill flings 50% of the blow at the nearest enemy', rarity: 'rare', unique: true, icon: itemIcon('dragon_claws'), effect: { kind: 'ricochet', frac: 0.5, radius: 95 } },
  ...
  // ── risk / reward curses ─────────────────────────────────────────────────
  { id: 'phoenix_necklace', name: 'Phoenix Necklace', desc: 'At 2 lives or fewer, ALL towers deal double damage', rarity: 'rare', unique: true, icon: itemIcon('phoenix_necklace'), effect: { kind: 'lastStand', belowLives: 2, mult: 2 } },
  ...
  { id: 'blood_pact', name: 'Blood Pact', desc: '+40% damage, but each wave cleared costs 1 life', rarity: 'rare', unique: true, icon: itemIcon('blood_shard'), effect: { kind: 'bloodPact', mult: 1.4 } },
  ...
  // ── tower transformations ────────────────────────────────────────────────
  { id: 'dragon_knife', name: 'Dragon Knife', desc: 'Ranged towers fire a second shot at another enemy', rarity: 'rare', unique: true, icon: itemIcon('dragon_knife'), effect: { kind: 'doubleShot' } },
  ...
  { id: 'clan_vexillum', name: 'Clan Vexillum', desc: '+8% damage per nearby tower of the same kind (max +40%)', rarity: 'ultra', unique: true, icon: itemIcon('clan_vexillum'), effect: { kind: 'packTactics', frac: 0.08, radius: 96, maxStacks: 5 } },
  { id: 'combat_triangle', name: 'Combat Triangle', desc: '+30% damage with both other combat styles nearby', rarity: 'ultra', unique: true, icon: ASSETS.misc.multicombat_icon, effect: { kind: 'trinity', mult: 1.3, radius: 96 } },
  { id: 'dinhs_bulwark', name: "Dinh's Bulwark", desc: 'Your tower nearest the portal deals +60% damage', rarity: 'ultra', unique: true, icon: itemIcon('dinhs_bulwark'), effect: { kind: 'vanguard', mult: 1.6 } },
  { id: 'lone_wolf', name: 'Lone Wolf', desc: '+50% damage for a tower standing alone', rarity: 'ultra', unique: true, icon: itemIcon('wolf_mask'), effect: { kind: 'loneWolf', mult: 1.5, radius: 96 } },
