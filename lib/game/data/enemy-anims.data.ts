...
// Do not edit by hand — re-bake and regenerate. 32 enemies, 85 clips.
...
export const ENEMY_ANIMS: Record<string, EnemyAnimSet> = {
  ...
  spider: {
    frameW: 128, frameH: 128,
    clips: {
      walk: { url: `${B}/spider/walk.png`, frames: 10, frameMs: [40, 40, 40, 40, 40, 40, 40, 40, 40, 40], loop: true },
      hurt: { url: `${B}/spider/hurt.png`, frames: 15, frameMs: [100, 100, 100, 80, 80, 100, 60, 40, 40, 40, 40, 40, 40, 40, 40], loop: false },
    },
  },
  skeleton: {
    frameW: 128, frameH: 128,
