...
/** The fourteen bosses a full run must defeat, for `perfect-roster`. */
export const CA_BOSS_ROSTER: readonly EnemyType[] = [
  'scurrius', 'brutus', 'giant_mole', 'dusk', 'dawn',
  'cerberus', 'zulrah', 'vorkath', 'jad', 'hydra', 'kbd', 'corporeal_beast', 'graardor', 'nex',
];
...
export const CA_TASKS: readonly CaTask[] = [
  ...
  {
    id: 'ward-breaker', tier: 'master', name: 'Ward Breaker',
    desc: 'Defeat Nex, breaking all four of her wards by killing the acolyte behind each one.',
    check: (s) => s.bossKillSeconds.nex !== undefined && s.bossFlags.nexAllWardsBroken,
  },
  {
  ...
  },
  {
    ...
    desc: 'Defeat all fourteen bosses in one run, losing no life to any of them.',
