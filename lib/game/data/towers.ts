...
export const TOWERS: Record<string, TowerDef> = {
  ...
  wizard: {
    ...
    tiers: [
      ...
      { level: 4, name: 'Ancient Magicks', damage: 28, cooldown: 5 * TICK * 1000, range: 8 * 25, color: '#7b68ee', upgradeCost: 0 }
    ]
  },
  cannon: {
    type: 'cannon',
    ...
    tiers: [
      ...
      { level: 4, name: 'Dragon Slayer Ballista', damage: 65, cooldown: 6 * TICK * 1000, range: 12 * 25, color: '#ff4500', upgradeCost: 0 }
    ]
  },
  tzhaar: {
    type: 'tzhaar',
    ...
    tiers: [
      ...
      { level: 4, name: "Inquisitor's Mace", damage: 85, cooldown: 4 * TICK * 1000, range: 3 * 25, color: '#ffd700', upgradeCost: 0 }
    ]
  },
  slayer: {
    type: 'slayer',
    ...
    tiers: [
      ...
      { level: 4, name: 'Zaryte Crossbow', damage: 95, cooldown: 4 * TICK * 1000, range: 9 * 25, color: '#0000ff', upgradeCost: 0 }
    ]
  },
  toxic: {
    type: 'toxic',
    ...
    tiers: [
      ...
      { level: 4, name: 'Magma Blowpipe', damage: 55, cooldown: 2 * TICK * 1000, range: 6 * 25, color: '#ff4500', upgradeCost: 0 }
    ]
  }
};
