...
export const PRAYERS: PrayerDef[] = [
  ...
  { id: 'mystic_lore', name: 'Mystic Lore', level: 27, drain: 3, description: '+10% Magic' },
  ...
  { id: 'mystic_might', name: 'Mystic Might', level: 45, drain: 5, description: '+15% Magic' },
