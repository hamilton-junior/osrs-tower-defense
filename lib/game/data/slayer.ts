...
export const SLAYER_MASTERS: SlayerMaster[] = [
  { id: 'turael', name: 'Turael', levelReq: 1, taskPool: ['goblin', 'rat', 'cow', 'imp', 'spider', 'skeleton', 'zombie', 'ghost', 'cave_bug', 'cave_slime', 'giant_bat', 'vulture', 'desert_lizard', 'jackal', 'kalphite_worker', 'wolf', 'giant_mosquito', 'tz_kih', 'tz_kek'], bonusMultiplier: 1.0, pointsPerTask: 2 },
